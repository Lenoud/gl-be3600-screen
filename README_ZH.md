...
`src/skyris_screen_clients.lua` 绘制一个小型的在线客户端仪表盘，分为**六个可滑动的页面**。
...
| 系统 | 设备 | 菜单 |
|------|------|------|
| ![系统](docs/img/system.png) | ![设备](docs/img/devices.png) | ![菜单](docs/img/menu.png) |
...
渲染单个页面后退出（0 = 首页，1 = 网速，2 = WAN，3 = 系统，之后是设备页，最后是菜单）—— 方便调试：
